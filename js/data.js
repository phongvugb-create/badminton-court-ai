...
const MockData = {
  ...
  // 2. BẢNG facilities (Danh sách cụm cơ sở sân thể thao, cầu lông & pickleball đa môn)
  facilities: [
    {
      id: 101,
    ...
    },
    {
      ...
      club_logo: "BÁCH KHOA",
      club_avatar_bg: "#fef2f2",
      club_avatar_color: "#dc2626",
      badges: ["Đơn ngày", "Sự kiện"],
      sport_type: "badminton",
      sport_icon: "🏸",
      courts_count: 10
    },
    {
      ...
      club_avatar_bg: "#f5f3ff",
      club_avatar_color: "#7c3aed",
      badges: ["Đơn ngày", "Sự kiện"],
      sport_type: "badminton",
      sport_icon: "🏸",
      courts_count: 14
    },
    {
      ...
      club_logo: "TÂY HỒ",
      club_avatar_bg: "#ecfeff",
      club_avatar_color: "#0891b2",
      badges: ["Đơn ngày", "Sự kiện"],
      sport_type: "badminton",
      sport_icon: "🏸",
      courts_count: 8
    },
    {
      ...
      club_logo: "HÀ ĐÔNG",
      club_avatar_bg: "#fdf4ff",
      club_avatar_color: "#c026d3",
      badges: ["Đơn ngày", "Sự kiện"],
      sport_type: "badminton",
      sport_icon: "🏸",
      courts_count: 12
    ...
    {
      id: 111,
      name: "Sân Bóng Đá Cỏ Nhân Tạo Cầu Giấy Arena",
    ...
    {
      id: 112,
      name: "Sân Bóng Rổ Hoop Star Mỹ Đình",
      address: "Đường Tân Mỹ, Mỹ Đình 1, Nam Từ Liêm, Hà Nội",
      distance: "7.9km",
      latitude: 21.0221,
      longitude: 105.7654,
      open_time: "06:00",
      ...
      img: "images/court2.jpg",
      club_logo: "HOOP STAR",
      club_avatar_bg: "#fff7ed",
      club_avatar_color: "#c2410c",
      badges: ["Đơn ngày"],
    ...
    {
      id: 113,
      name: "CLB Quần Vợt & Tennis Quần Ngựa",
      ...
      img: "images/court3.jpg",
      club_logo: "QUẦN NGỰA",
      club_avatar_bg: "#fefce8",
      club_avatar_color: "#a16207",
      badges: ["Đơn ngày", "Sự kiện"],
      sport_type: "tennis",
      sport_icon: "🎾",
      courts_count: 6
    ...
    {
      id: 114,
      name: "Khu Thể Thao Đa Năng Định Công",
      ...
      img: "images/court4.jpg",
      club_logo: "ĐỊNH CÔNG",
      club_avatar_bg: "#ffe4e6",
      club_avatar_color: "#e11d48",
      badges: ["Đơn ngày", "Sự kiện"],
      sport_type: "multi",
      sport_icon: "🏟️",
      courts_count: 8
    ...
    {
      id: 115,
      name: "Pickleball & Badminton Hub Ciputra",
      ...
      img: "images/court5.jpg",
      club_logo: "CIPUTRA",
      club_avatar_bg: "#e0f2fe",
      club_avatar_color: "#0369a1",
      badges: ["Đơn ngày", "Sự kiện"],
      sport_type: "pickleball",
      sport_icon: "🎾",
      courts_count: 12
